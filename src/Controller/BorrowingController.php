...
class BorrowingController extends AbstractController
{
    ...
    #[Route('/admin' ,name:'app_borrowing_admin' )]
    #[IsGranted('ROLE_ADMIN')]
    public function index(BorrowingRepository $borrowingRepository):Response
    {
                return $this->render('borrowing/admin.html.twig',['borrowings' => $borrowingRepository->findAllActive()]) ;
      }
    ...
    public function myBorrowings(BorrowingRepository $borrowingRepository): Response
    {
        ...
        //  $borrowings = $borrowingRepository->findAllByUser($this->getUser());
