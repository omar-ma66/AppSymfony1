 ...
 */
final class Version20260528075617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrowing (id INT AUTO_INCREMENT NOT NULL, borrowed_at DATETIME NOT NULL, return_at DATETIME DEFAULT NULL, user_id INT NOT NULL, book_id INT NOT NULL, INDEX IDX_226E5897A76ED395 (user_id), INDEX IDX_226E589716A2B381 (book_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A331F675F31B FOREIGN KEY (author_id) REFERENCES auteur (id)');
